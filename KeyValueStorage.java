...
public class KeyValueStorage {
    ...
    private static void creatTreeKeyValueFile(File file,String storagePath) throws Exception {
        //新建文件
    ...
    private static String creatTreeKeyValueFileOfHomeFolder(File file,String storagePath) throws Exception {
        //获取主文件夹的hash值
    ...
    public static String creatKeyValueOfPath(String filePath)throws Exception{
        ...
        return creatTreeKeyValueFileOfHomeFolder(file,storagePath);
    }
